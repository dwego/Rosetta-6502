...
/* 
   This is a header file for the LDY (Load Index Register Y) instruction for MOS Technology 6502.
   LDY works by moving a value into the Index Register Y (Y).
   For more information about the instructions, refer to Instructions.MD
*/ 

/* 
   LDY (Load Index Register Y) instruction supports various addressing modes in the 6502 architecture.
   The different modes provide fleYibility in specifying the source of the data to be loaded into the Index Register Y, (Y).
*/   


/* 
   LDY_IM - Load Index Register Y with Immediate value.
   This function fetches a byte from memory and loads it into the Index Register Y (Y).
   It then sets the status flags using LDYSetStatus.
*/ 
...
/* 
   ...
   value at that address, and loads it into the Index Register Y (Y). It then sets the status flags.
*/ 
...
/* 
   ...
   Similar to LDY_ZP, but adds the X register value to the zero-page address before reading
...
/* 
   ...
   and loads it into the Index Register Y (Y). It then sets the status flags.
*/ 
...
/* 
   ...
   Similar to LDY_ABS, but adds the X register value to the absolute address before reading
   the value from memory. It adjusts the cycle count accordingly and sets the status flags.
*/ 
